		...
		<div class="row col-md-8 offset-md-2">
			...
			<form action="list" id="list_form" class="row row-cols-lg-auto g-3 align-items-center" style="margin-top: 3px;">
			  ...
			  <div class="btn-group">
				...
				<a href="/boards/place/heartlist" id="cardlist" class="btn btn-outline-primary"><i class="bi bi-heart-fill"></i></a>
			  </div>
			...
			<table class="table table-striped">
				...
				<c:forEach items="${list}" var="f">
					<tr onclick="location.href='/boards/detail?boardNum=${f.boardNum}'">
						<td>${f.boardNum}</td>
						<td>${f.boardTitle}</td>
						<td>${f.userID}</td>
						<td>${f.boardDate}</td>
