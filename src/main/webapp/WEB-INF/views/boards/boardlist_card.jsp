...
<body>
	...
	<div class="container-fluid my-5">
		<div class="row col-md-8 offset-md-2">
			...
			<div class="col-12">
				<label class="visually-hidden" for="inlineFormSelectPref">test</label>
				<select name="order" class="form-select" id="inlineFormSelectPref">
				  <option value="o1">즐겨찾기 많은 순</option>
				  <option value="o2">팔로우 많은 순</option>
				  <option value="o3">조회수 많은 순</option>
				  <option value="o4">댓글 많은 순</option>
				</select>
			  </div>
