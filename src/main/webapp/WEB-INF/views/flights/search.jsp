	...
	<div style="margin-top: 100px;">
		<div class="row col-md-8 offset-md-2">
			...
			<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
				...
				<li class="nav-item" role="presentation">
					<button class="nav-link" id="pills-hotels-tab" data-bs-toggle="pill" data-bs-target="#pills-hotels" type="button" role="tab" aria-controls="pills-hotels" aria-selected="false">숙소 검색</button>
				</li>
			</ul>
								...
								<div class="col">
									<div>
										<div style="float: inline-end;">
											...
											<input type="text" style="width: 20px;" value="1" data-max="9" data-min="0" id="adult">
								...
								<div class="col">
									<div>
										<div style="float: inline-end;">
											...
											<input type="text" style="width: 20px;" value="0" data-max="9" data-min="0" id="child">
											<button class="btn increase">
												<i class="bi bi-plus-lg" style="font-size: 1.2rem;"></i>
											</button>
										</div>
								...
								<div class="col">
									<div>
										<div style="float: inline-end;">
											...
											<input type="text" style="width: 20px;" value="0" data-max="9" data-min="0" id="infant">
											<button class="btn increase">
												<i class="bi bi-plus-lg" style="font-size: 1.2rem;"></i>
											</button>
										</div>
