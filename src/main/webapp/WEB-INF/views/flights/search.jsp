			...
			<div class="row mt-5">
				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="home-tab-pane"
						...
						<form id="searchfrm" action="./list" method="POST">
							<div class="input-group mb-3">
								<label class="input-group-text" for="select01">출발지</label>
								<select	class="form-select" id="depAirportNm" name="depAirportNm">

								</select>
							</div>
							<div class="input-group mb-3">
								<span class="input-group-text">가는 날</span>
								<input type="date" name="plandGoDate" id="plandGoDate" class="form-control">
							</div>
							<div class="input-group mb-3">
								<span class="input-group-text">오는 날</span>
								<input type="date" name="plandComeDate" id="plandComeDate" class="form-control">
							</div>
							<div class="input-group mb-3">
								<span class="input-group-text" id="inputGroup-sizing-sm">인원</span>
								<input type="text" class="form-control" aria-label="Sizing example input"	aria-describedby="inputGroup-sizing-sm" id="person" name="person">
							</div>
							<div>
