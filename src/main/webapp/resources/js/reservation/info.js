        ...
        if(r.trim().length > 0) {
          ...
          cardPay.addEventListener("click", ()=>{
            payment.requestPayment({
              ...
              successUrl: window.location.origin + "/reservation/success?payment=card",
          ...
          fakeAccount.addEventListener("click", ()=>{
            payment.requestPayment({
              ...
              orderId: rdm,
              orderName: "예약자 포함 "+(person)+"인",
              successUrl: window.location.origin + "/reservation/success?payment=virtual_account",
              failUrl: window.location.origin + "/reservation/fail",
              customerEmail: email.value,
              customerName: r,
              virtualAccount: {
          ...
          realAccount.addEventListener("click", ()=>{
            payment.requestPayment({
              ...
              orderId: rdm,
              orderName: "예약자 포함 "+(person)+"인",
              successUrl: window.location.origin + "/reservation/success?payment=transfer",
              failUrl: window.location.origin + "/reservation/fail",
              customerEmail: email.value,
              customerName: r,
              transfer: {
          ...
          phonePay.addEventListener("click", ()=>{
            payment.requestPayment({
              ...
              orderId: rdm,
              orderName: "예약자 포함 "+(person)+"인",
              successUrl: window.location.origin + "/reservation/success?payment=mobile_phone",
              failUrl: window.location.origin + "/reservation/fail",
              customerEmail: email.value,
              customerName: r,
            });
