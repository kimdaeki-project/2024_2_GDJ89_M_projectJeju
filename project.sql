...
CREATE TABLE PRODUCTS(
	...
	CONSTRAINT PRODUCT_PK PRIMARY KEY (PRODUCTNUM),
	CONSTRAINT H_P_FK FOREIGN KEY (REMARK) REFERENCES HOTEL(REMARK)
)
...
CREATE TABLE HOTEL(
	...
	CONSTRAINT HOTEL_PK PRIMARY KEY (REMARK)
)
...
CREATE TABLE PRODUCTFILES(
	...
	FILENAME VARCHAR2(200) NOT NULL,
	OLDNAME VARCHAR2(200) NOT NULL,
	CONSTRAINT PFILE_PK PRIMARY KEY (FILENUM),
	CONSTRAINT F_P_FK FOREIGN KEY (PRODUCTNUM) REFERENCES PRODUCTS(PRODUCTNUM)
)
